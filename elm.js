...
var $author$project$Main$void = function (m) {
...
var $author$project$Main$load = function (flags) {
...
var $author$project$Main$encode = function (m) {
	return A3($elm$json$Json$Encode$dict, $elm$core$Basics$identity, $elm$json$Json$Encode$string, m.bookmarks);
};
var $author$project$Main$write = _Platform_outgoingPort('write', $elm$core$Basics$identity);
var $author$project$Main$save = function (m) {
	return _Utils_Tuple2(
		m,
		$author$project$Main$write(
			$author$project$Main$encode(m)));
};
var $author$project$Main$update = F2(
	function (event, model) {
		switch (event.$) {
			case 'Create':
				return (!($elm$core$String$isEmpty(model.flux.name) || $elm$core$String$isEmpty(model.flux.url))) ? $author$project$Main$save(
					_Utils_update(
						model,
						{
							bookmarks: A3($elm$core$Dict$insert, model.flux.name, model.flux.url, model.bookmarks)
						})) : $author$project$Main$void(model);
			case 'Delete':
				var name = event.a;
...
var $author$project$Main$bookmark = function (_v0) {
	var name = _v0.a;
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$Delete(name))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text('')
			...
			[
				...
				_List_fromArray(
					[
						...
						$author$project$Main$Typing($author$project$Main$Name))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						...
						$elm$html$Html$Events$onInput(
						$author$project$Main$Typing($author$project$Main$Url))
					]),
				_List_Nil),
				A2(
				$elm$html$Html$button,
